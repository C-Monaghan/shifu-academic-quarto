...
% ===================================
% This preamble provides APA-style formatting and Quarto compatibility
% Last updated: 2025-10-15

% PACKAGES & TYPOGRAPHY SETTINGS
% ==============================

% Paragraph formatting - APA style requires 0.5" indentation
\setlength{\parindent}{1pc}      % First line paragraph indentation
\setlength{\leftmargin}{0.5in}   % Left margin for block elements
...
% Heading styles following APA guidelines:
